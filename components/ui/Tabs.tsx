import { Button } from '@/components/ui/functions/button';
import {
    Card,
    CardContent,
    CardDescription,
    ...
    CardHeader,
    CardTitle,
} from '@/components/ui/functions/card';
import { Input } from '@/components/ui/functions/input';
import { Label } from '@/components/ui/functions/label';
import { Tabs, TabsContent, TabsList, TabsTrigger } from '@/components/ui/functions/tabs';
import { Text } from '@/components/ui/functions/text';
